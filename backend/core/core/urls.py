...
urlpatterns = [
    ...
    path(r'api/moments/feed/<int:pk>/', MomentsViewSet.as_view({'get':'list'})),
    ...
    path(r'api/users/search/', UserViewSet.as_view({'get':'list'}), name='user-detail-by-usernames'),
    path(r'api/users/<str:username>/', get_user_id_by_username, name='user-detail-by-username'),
    path(r'api/users/username/<int:user_id>/', get_username_by_user_id, name='user-detail-by-userid'),
    path(r'api/users/photo/<int:user_id>/', get_photo_by_user_id, name='user-photo'),

    path(r'api/subscriptions/<int:main_user_id>/<int:user_id>', get_is_subscribed, name='subscriptions-is-subscribed'),
    ...
    path(r'api/likeonmoments/count/<int:moment_id>', get_count_likes, name='likeOnMoment-count'),
    path(r'api/likeonmoments/<int:user_id>/<int:moment_id>', get_is_liked, name='likeOnMoment-is-liked'),
